function ydata = tsne(X, labels, no_dims, initial_dims, perplexity,figure_handle)
...
% University of California, San Diego
    ...
    % Run t-SNE
    if initial_solution
        ydata = tsne_p(P, labels, ydata,figure_handle);
    else
        ydata = tsne_p(P, labels, no_dims,figure_handle);
    end
